...
function Section({
  ...
  return (
    <section className={accent}>
      <hr className="border-accent/50 border-t-4 border-dotted" />
      <h2 className="text-accent/50 mb-6 select-none text-3xl font-black uppercase leading-none tracking-tighter">
        {title}
      </h2>
