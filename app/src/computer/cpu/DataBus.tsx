...
dataBus.addNode("FP", { position: [451, 357] });
...
dataBus.addNode("FP join", { position: [421, 357] });
...
dataBus.addUndirectedEdge("FP", "FP join");
dataBus.addUndirectedEdge("ri", "ri join");
dataBus.addUndirectedEdge("IP join", "SP join");
dataBus.addUndirectedEdge("SP join", "FP join");
dataBus.addUndirectedEdge("FP join", "ri join");
