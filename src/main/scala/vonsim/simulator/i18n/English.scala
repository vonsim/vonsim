...
class English extends SimulatorLanguage {
  ...
  def memoryCellAsInstruction =
    "Attempting to interpretate a random memory cell as an instruction. Check that your program contains all the HLT instructions necessary, and that there are instructions in address 2000h."
