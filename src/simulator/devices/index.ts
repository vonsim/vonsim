  ...
  setIOMemory: (address, size, value) => {
    ...
    const byte = (address: number, value: number) =>
      match<number, SimulatorResult<void>>(address)
        ...
        .with(0x30, () => Ok(get().devices.pio.setRegister("PA", value)))
        .with(0x31, () => Ok(get().devices.pio.setRegister("PB", value)))
        .with(0x32, () => Ok(get().devices.pio.setRegister("CA", value)))
        .with(0x33, () => Ok(get().devices.pio.setRegister("CB", value)))
